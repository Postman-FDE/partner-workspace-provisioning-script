...
Both approaches expose the same core functionality: full provisioning (including mock environment creation and collection variable mapping), custom provisioning, full reset, custom reset, admin management, and partner invitations.
